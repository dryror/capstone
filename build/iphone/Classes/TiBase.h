...
// in simulator we redefine to format for LTEMA Developer console
...
{\
	NSString * exceptionName = [@"org.ltema." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ltema";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UILTEMANativeItemNone = -1, 
	UILTEMANativeItemSpinner = -2,
	UILTEMANativeItemProgressBar = -3,
	
	UILTEMANativeItemSlider = -4,
	UILTEMANativeItemSwitch = -5,
	UILTEMANativeItemMultiButton = -6,
	UILTEMANativeItemSegmented = -7,
	
	UILTEMANativeItemTextView = -8,
	UILTEMANativeItemTextField = -9,
	UILTEMANativeItemSearchBar = -10,
	
	UILTEMANativeItemPicker = -11,
	UILTEMANativeItemDatePicker = -12,
	
	UILTEMANativeItemInfoLight = -13,
	UILTEMANativeItemInfoDark = -14,
	
	UILTEMANativeItemDisclosure = -15,
	
	UILTEMANativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all LTEMA instances of
